// Package backup hosts the DocumentDB E2E backup area. See
...
var _ = SynchronizedAfterSuite(
	...
	func(ctx SpecContext) {
		if err := e2e.TeardownSuite(ctx); err != nil {
			fmt.Fprintf(GinkgoWriter, "backup teardown: %v\n", err)
		}
	},
)
