// Package data hosts the DocumentDB E2E data area. See
...
var _ = SynchronizedAfterSuite(
	...
	func(ctx SpecContext) {
		if err := e2e.TeardownSuite(ctx); err != nil {
			fmt.Fprintf(GinkgoWriter, "data teardown: %v\n", err)
		}
	},
)
