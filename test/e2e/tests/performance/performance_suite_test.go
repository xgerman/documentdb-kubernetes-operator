// Package performance hosts the DocumentDB E2E performance area. See
...
var _ = SynchronizedAfterSuite(
	...
	func(ctx SpecContext) {
		if err := e2e.TeardownSuite(ctx); err != nil {
			fmt.Fprintf(GinkgoWriter, "performance teardown: %v\n", err)
		}
	},
)
