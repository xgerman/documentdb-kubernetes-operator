// Package scale hosts the DocumentDB E2E scale area. See
...
var _ = SynchronizedAfterSuite(
	...
	func(ctx SpecContext) {
		if err := e2e.TeardownSuite(ctx); err != nil {
			fmt.Fprintf(GinkgoWriter, "scale teardown: %v\n", err)
		}
	},
)
