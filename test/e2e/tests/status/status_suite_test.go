// Package status hosts the DocumentDB E2E status area. See
...
var _ = SynchronizedAfterSuite(
	...
	func(ctx SpecContext) {
		if err := e2e.TeardownSuite(ctx); err != nil {
			fmt.Fprintf(GinkgoWriter, "status teardown: %v\n", err)
		}
	},
)
